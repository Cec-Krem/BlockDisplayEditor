...
public enum ToolType {
    ...
    SCALE_ALL           (21,Material.QUARTZ,                "Scale (All)"),
    SHRINK_INTERACTION  (22,Material.PRISMARINE_CRYSTALS,   "Shrink Interaction"),
    RAY_DRAG            (23,Material.STRUCTURE_VOID,        "Ray Drag"),
